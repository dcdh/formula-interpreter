...
class ArithmeticExpressionTestProvider {
c'est null parce que le test est illisible
    private static Map<ArithmeticFunction.Function, Supplier<Stream<Arguments>>> ARGUMENTS_BY_ARITHMETIC_FUNC = Map.of(
            ArithmeticFunction.Function.ADD, ArithmeticFunctionTestProvider::provideAddition,
            ArithmeticFunction.Function.SUB, ArithmeticFunctionTestProvider::provideSubtraction,
            ArithmeticFunction.Function.DIV, ArithmeticFunctionTestProvider::provideDivision,
            ArithmeticFunction.Function.MUL, ArithmeticFunctionTestProvider::provideMultiplication
    );

    public static Stream<Arguments> provideOperationForStructuredReferenceLeftAndStructuredReferenceRight() {
        return ARGUMENTS_BY_ARITHMETIC_FUNC.entrySet()
                .stream()
                .flatMap(entry -> {
                    final ArithmeticFunction.Function function = entry.getKey();
                    ...
                    return entry.getValue().get().map(arguments -> {
                        ...
                        return Arguments.of(
                                new Given(
                                        givenFormula,
                                        new ArithmeticExpression(function,
