        ...
        return Stream.of(
                Arguments.of(
                        ...
                        new ArithmeticExpression(ArithmeticFunction.Function.ADD,
                                new ArgumentExpression(new Value("10"), new Range(4, 5)),
                                new ArithmeticExpression(ArithmeticFunction.Function.MUL,
                                        new ArgumentExpression(new Value("20"), new Range(11, 12)),
                                        new ArgumentExpression(new Value("30"), new Range(14, 15)),
                                        new Range(7, 16)),
                                new Range(0, 17)),
                        new Value("610"))
        );
