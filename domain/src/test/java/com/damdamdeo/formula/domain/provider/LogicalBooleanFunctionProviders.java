...
public final class LogicalBooleanFunctionProviders {
    ...
    private Stream<LogicalBooleanFunction> common() {
        return Stream.of(
                ...
                new LogicalBooleanFunction(new GivenLeft(new Value("azerty")), new GivenRight(new Value("260")), new Expected(Value.ofLogicalValueExpected())),
                new LogicalBooleanFunction(new GivenLeft(Value.ofTrue()), new GivenRight(new Value("260")), new Expected(Value.ofLogicalValueExpected())),
                new LogicalBooleanFunction(new GivenLeft(Value.ofFalse()), new GivenRight(new Value("260")), new Expected(Value.ofLogicalValueExpected())),
                ...
                new LogicalBooleanFunction(new GivenLeft(Value.ofNumericalValueExpected()), new GivenRight(new Value("260")), new Expected(Value.ofNumericalValueExpected())),
                ...
                new LogicalBooleanFunction(new GivenLeft(new Value("660")), new GivenRight(new Value("azerty")), new Expected(Value.ofLogicalValueExpected())),
                new LogicalBooleanFunction(new GivenLeft(new Value("660")), new GivenRight(Value.ofTrue()), new Expected(Value.ofLogicalValueExpected())),
                new LogicalBooleanFunction(new GivenLeft(new Value("660")), new GivenRight(Value.ofFalse()), new Expected(Value.ofLogicalValueExpected())),
                ...
                new LogicalBooleanFunction(new GivenLeft(new Value("660")), new GivenRight(Value.ofNumericalValueExpected()), new Expected(Value.ofNumericalValueExpected())),
