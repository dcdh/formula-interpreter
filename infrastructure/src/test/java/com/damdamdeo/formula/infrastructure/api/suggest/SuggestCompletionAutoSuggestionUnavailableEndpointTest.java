...
@ExtendWith(SuggestCompletionAutoSuggestionUnavailableEndpointTest.AntlrSuggestCompletionTestResolver.class)
@QuarkusTest
public class SuggestCompletionAutoSuggestionUnavailableEndpointTest {

    @InjectMock
    SuggestCompletion suggestCompletion;

    @SuggestCompletionTestResolver.DomainValidationExceptionTest
    public void shouldHandleAutoSuggestUnavailableException(final SuggestedFormula suggestedFormula,
    ...
    static class AntlrSuggestCompletionTestResolver extends SuggestCompletionTestResolver {
        ...
        protected SuggestionException suggestionException() {
            return new SuggestionException(new AntlrAutoSuggestUnavailableException(suggestedFormulaInError, new RuntimeException("error")));
        }
    }
