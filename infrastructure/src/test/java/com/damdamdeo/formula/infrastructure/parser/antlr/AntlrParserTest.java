...
//        antlrExecutor = new AntlrParser(processedAtProvider,
//                new DefaultAntlrParseTreeGenerator(processedAtProvider),
...
//
//    @Test
//    public void shouldLogWhenDebugFeatureIsActive(final ProcessedAtProvider processedAtProvider) {
//        // Given
//        final PartEvaluationCallback givenPartEvaluationCallback = new PartEvaluationCallback(new DebugPartEvaluationListener(processedAtProvider),
