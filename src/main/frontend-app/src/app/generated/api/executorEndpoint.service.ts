...
// @ts-ignore
import { ExecuteDTO } from '../model/executeDTO';
// @ts-ignore
import { ExecutionResultDTO } from '../model/executionResultDTO';
...
export class ExecutorEndpointService {
    ...
    public execute(executeDTO?: ExecuteDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.formula-execution-v1+json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/execute`;
        return this.httpClient.request<ExecutionResultDTO>('post', `${this.configuration.basePath}${localVarPath}`,
            {
