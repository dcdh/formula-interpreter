...
export class SuggestCompletionEndpointService {
    ...
    public suggestCompletion(suggestedFormula?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.suggest-completion-v1+json', context?: HttpContext}): Observable<any> {
        ...
        if (suggestedFormula !== undefined) {
            localVarFormParams = localVarFormParams.append('suggestedFormula', <any>suggestedFormula) as any || localVarFormParams;
        }
        ...
        let localVarPath = `/suggestCompletion`;
