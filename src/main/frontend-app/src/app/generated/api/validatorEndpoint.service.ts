...
// @ts-ignore
import { SyntaxErrorDTO } from '../model/syntaxErrorDTO';
...
export class ValidatorEndpointService {
    ...
    public validate(formula?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.formula-validator-v1+json' | 'application/vnd.validation-unexpected-exception-v1+text', context?: HttpContext}): Observable<any> {
        ...
        if (formula !== undefined) {
            localVarFormParams = localVarFormParams.append('formula', <any>formula) as any || localVarFormParams;
        }
        ...
        let localVarPath = `/validate`;
        return this.httpClient.request<SyntaxErrorDTO>('post', `${this.configuration.basePath}${localVarPath}`,
            {
